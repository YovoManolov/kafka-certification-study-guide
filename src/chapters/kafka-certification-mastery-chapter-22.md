...
```mermaid
flowchart LR
    A["Scenario"] --> B["Identify symptom"]
    B --> C["Determine scope"]
    C --> D["Collect evidence"]
    D --> E["Eliminate wrong hypotheses"]
    E --> F["Choose action"]
    F --> G["Verify result"]
```

## 22.2 The Certification Scenario Mindset
...
## 22.3 The Universal Kafka Diagnostic Framework
...
## 22.4 First Question: What Changed?
...
## 22.5 Second Question: What Is the Blast Radius?
...
## 22.6 Scenario 1 --- Producer Cannot Connect
...
## 22.7 Scenario 2 --- Bootstrap Works, Metadata Fails
...
## 22.8 Scenario 3 --- TLS Handshake Failure
...
## 22.9 Scenario 4 --- SASL Authentication Failure
...
## 22.10 Scenario 5 --- Authentication Works, Authorization Fails
...
## 22.11 Scenario 6 --- Producer Cannot Write
...
## 22.12 Scenario 7 --- Producer Latency Suddenly Increases
...
## 22.13 Scenario 8 --- Producer Throughput Is Low
...
## 22.14 Scenario 9 --- Producer Buffer Exhaustion
...
## 22.15 Scenario 10 --- In-Flight Requests
...
## 22.16 Scenario 11 --- Consumer Lag Suddenly Increases
...
## 22.17 Scenario 12 --- One Partition Has Huge Lag
...
## 22.18 Scenario 13 --- All Partitions Have Increasing Lag
...
## 22.19 Scenario 14 --- Consumer Group Rebalances Continuously
...
## 22.20 Scenario 15 --- Consumer Processing Is Slow
...
## 22.21 Scenario 16 --- Consumer Crashes on One Record
...
## 22.22 Scenario 17 --- Consumer Group Has No Active Members
...
## 22.23 Scenario 18 --- Consumer Has Topic Access but Cannot Join Group
...
## 22.24 Scenario 19 --- Broker Disk Is Filling
...
## 22.25 Scenario 20 --- Retention Appears Not to Work
...
## 22.26 Scenario 21 --- Compacted Topic Keeps Growing
...
## 22.28 Scenario 23 --- Multiple Brokers Leave ISR
...
## 22.29 Scenario 24 --- `min.insync.replicas` Blocks Writes
...
## 22.30 Scenario 25 --- Unclean Leader Election
...
## 22.31 Scenario 26 --- Broker Failure
...
## 22.32 Scenario 27 --- Broker Recovers but Cluster Is Slow
...
## 22.34 Scenario 29 --- Hot Partition
...
## 22.35 Scenario 30 --- Adding Partitions Changes Key Distribution
...
## 22.36 Scenario 31 --- Network Timeout
...
## 22.37 Scenario 32 --- DNS Resolves but Kafka Fails
...
## 22.38 Scenario 33 --- TLS Works Internally but Fails Externally
...
## 22.39 Scenario 34 --- SASL_SSL vs SSL
...
## 22.40 Scenario 35 --- Wrong Listener Security Protocol
...
## 22.41 Scenario 36 --- ACL Looks Correct but Access Still Fails
...
## 22.42 Scenario 37 --- Consumer Can Read Topic but Cannot Commit
...
## 22.43 Scenario 38 --- Producer Gets Message Too Large
...
## 22.44 Scenario 39 --- Increasing JVM Heap Makes Kafka Slower
...
## 22.46 Scenario 41 --- Disk Latency Is High
...
## 22.47 Scenario 42 --- Consumer Lag Is Caused by Downstream Database
...
## 22.48 Scenario 43 --- Consumer Lag After Deployment
...
## 22.49 Scenario 44 --- Producer Works but Records Are Delayed
...
## 22.50 Scenario 45 --- Ordering Requirement
...
## 22.51 Scenario 46 --- Need Global Ordering
...
## 22.52 Scenario 47 --- Duplicate Records
...
## 22.53 Scenario 48 --- Consumer Processes Record but Crashes Before Commit
...
## 22.54 Scenario 49 --- Exactly-Once Requirement
...
## 22.55 Scenario 50 --- Transactional Producer Fails
...
## 22.56 Scenario 51 --- Consumer Uses `read_uncommitted`
...
## 22.57 Scenario 52 --- Schema Compatibility Failure
...
## 22.58 Scenario 53 --- Kafka Connect Task Fails
...
## 22.59 Scenario 54 --- Kafka Streams Application Falls Behind
...
## 22.60 Scenario 55 --- Streams Rebalance Loop
...
## 22.61 Scenario 56 --- KRaft Metadata Quorum Problem
...
## 22.62 Scenario 57 --- Broker Restart During Incident
...
## 22.63 Scenario 58 --- Two Brokers Fail
...
## 22.64 Scenario 59 --- Rack/AZ Awareness
...
## 22.65 Scenario 60 --- Cross-Region Replication Is Slow
...
## 22.66 Scenario 61 --- Cluster Expansion
...
## 22.67 Scenario 62 --- Too Many Partitions
...
## 22.68 Scenario 63 --- Disk Capacity Planning
...
## 22.69 Scenario 64 --- Retention Calculation
...
## 22.70 Scenario 65 --- Recovery Capacity
...
## 22.71 Scenario 66 --- Monitoring Shows High Request Queue
...
## 22.72 Scenario 67 --- Network Processor Idle Is Low
...
## 22.73 Scenario 68 --- High GC Pause
...
## 22.74 Scenario 69 --- Connection Churn
...
## 22.75 Scenario 70 --- Consumer Group Has Too Many Consumers
...
## 22.76 Scenario 71 --- Rebalance After Every Deployment
...
## 22.77 Scenario 72 --- Producer Sends to Wrong Partition
...
## 22.78 Scenario 73 --- Same-Key Records Are Not Ordered
...
## 22.79 Scenario 74 --- Duplicate Business Effects
...
## 22.80 Scenario 75 --- Consumer Commits Before Processing
...
## 22.81 Scenario 76 --- At-Most-Once vs At-Least-Once
...
## 22.82 Scenario 77 --- Consumer Wants More Parallelism
...
## 22.83 Scenario 78 --- Producer Ordering and Retries
...
## 22.84 Scenario 79 --- Consumer Lag After Broker Failure
...
## 22.85 Scenario 80 --- Cluster Is Healthy but Application Is Not
...
## 22.86 Scenario 81 --- The Best First Action
...
## 22.87 Scenario 82 --- Broker Disk Exhaustion
...
## 22.88 Scenario 83 --- Producer Authorization Failure
...
## 22.89 Scenario 84 --- Bootstrap Works but Produce Fails
...
## 22.91 Scenario 86 --- Kafka Throughput Is Low
...
## 22.92 Scenario 87 --- Broker Failure
...
## 22.93 Scenario 88 --- Incident Prioritization
...
## 22.94 Scenario 89 --- Mitigation vs Root Cause
...
## 22.96 Scenario 91 --- Change One Variable at a Time
...
## 22.97 Scenario 92 --- Evidence Hierarchy
...
## 22.98 Scenario 93 --- Logs vs Metrics vs Traces
...
## 22.99 Scenario 94 --- Certification Time Management
...
## 22.100 The Certification Elimination Method
...
## 22.104 The 12 High-Value Diagnostic Questions
...
## 22.105 Final 20-Second Mental Model
...
## 22.106 Certification Trap Matrix
...
## 22.111 Final Challenge --- Senior Certification Drill
...
## 22.112 Answers to the Final Challenge
...
[Mock Exam #1 — Developer Fundamentals + Producer/Consumer](../mocks/mock-exam-1.md)
